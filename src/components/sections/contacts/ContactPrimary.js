                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="input-item input-item-name ltn__custom-icon">
                      ...
                      />
                      {errors.name ? (
                        <small id="contact-name-error" className="text-danger">
                          {errors.name}
                        </small>
                      ) : null}
                    </div>
                  ...
                  <div className="col-md-6">
                    <div className="input-item input-item-email ltn__custom-icon">
                      ...
                      />
                      {errors.email ? (
                        <small id="contact-email-error" className="text-danger">
                          {errors.email}
                        </small>
                      ) : null}
                    </div>
                  ...
                  <div className="col-md-6">
                    <div className="input-item input-item-phone ltn__custom-icon">
                      ...
                      />
                      {errors.phone ? (
                        <small id="contact-phone-error" className="text-danger">
                          {errors.phone}
                        </small>
                      ) : null}
                    </div>
                  ...
                  <div className="col-md-6">
                    <div className="input-item input-item-name ltn__custom-icon">
                      <input
                        ...
                        aria-describedby={errors.gymName ? "contact-gym-error" : undefined}
                        required
                      />
                      {errors.gymName ? (
                        <small id="contact-gym-error" className="text-danger">
                          {errors.gymName}
                        </small>
                      ) : null}
                    </div>
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="input-item input-item-textarea">
                      ...
                      />
                      {errors.address ? (
                        <small id="contact-address-error" className="text-danger">
                          {errors.address}
                        </small>
                      ) : null}
                    </div>
                  ...
                  <div className="col-md-6">
                    <div className="input-item input-item-number input-item-members ltn__custom-icon">
                      <input
                        ...
                        aria-describedby={errors.members ? "contact-members-error" : undefined}
                        required
                      />
                      {errors.members ? (
                        <small id="contact-members-error" className="text-danger">
                          {errors.members}
                        </small>
                      ) : null}
                    </div>
                  ...
                  <div className="col-md-6">
                    <div className="input-item input-item-number input-item-equipment ltn__custom-icon">
                      <input
                        ...
                        aria-describedby={errors.equipments ? "contact-equipments-error" : undefined}
                        required
                      />
                      {errors.equipments ? (
                        <small id="contact-equipments-error" className="text-danger">
                          {errors.equipments}
                        </small>
                      ) : null}
                    </div>
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="input-item">
                      ...
                      {errors.serviceType ? (
                        <small id="contact-service-error" className="text-danger d-block mt-5">
                          {errors.serviceType}
                        </small>
                      ) : null}
                    </div>
                  ...
                  <div className="col-12">
                    <div className="input-item input-item-textarea ltn__custom-icon">
                      <textarea
                        ...
                        aria-describedby={
                          errors.contactTime ? "contact-contact-time-error" : undefined
                        }
                        required
                      />
                      {errors.contactTime ? (
                        <small id="contact-contact-time-error" className="text-danger">
                          {errors.contactTime}
                        </small>
                      ) : null}
                    </div>
