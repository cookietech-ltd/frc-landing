...
import blogImage2 from "@/assets/img/blog/blog-details/2.jpg"; 
import blogImage3 from "@/assets/img/service/31.jpg"; 
import blogImage4 from "@/assets/img/service/32.jpg"; 
import blogImage5 from "@/assets/img/blog/blog-details/1.jpg"; 
import blogImage6 from "@/assets/img/service/33.jpg"; 
import blogImage7 from "@/assets/img/blog/blog-details/3.jpg";
import blogImage8 from "@/assets/img/service/34.jpg";
import blogImage9 from "@/assets/img/blog/blog-details/4.jpg";
import blogImage10 from "@/assets/img/service/35.jpg";
import blogImage11 from "@/assets/img/blog/blog-details/5.jpg";
import blogImage12 from "@/assets/img/service/36.jpg"; // Placeholder
import blogImage13 from "@/assets/img/blog/blog-details/6.jpg"; // Placeholder
import blogImage14 from "@/assets/img/service/37.jpg"; // Placeholder
...
import authorZach from "@/assets/img/team/5.jpg"; // Placeholder for Zach M. (RSM)
  ...
  const blogs = [
    // --- CEO ARTICLES (IDs 1-3) ---
    {
      ...
      author: {
        name: "Ron M.",
        image: authorRon,
        designation: "CEO, Fitness Room Concierge",
      },
      ...
      fullContent: `
        ...
        <p>When I talk with gym owners across the country, I hear the same thing again and again: "We just deal with broken equipment. It is part of the business."</p>
        ...
        <p>We created Fitness Room Concierge to remove that burden. At FRC our goal is simple. When your equipment runs, your business runs.</p>
        <h3 class="ltn__blog-title mt-30">DOWNTIME CREATES REAL COSTS</h3>
        <p>Downtime affects more than finances. It affects trust. Member confidence drops. Staff frustration increases. Delayed decisions create more problems. Gyms should not absorb these issues simply because the service model is outdated.</p>
        <h3 class="ltn__blog-title mt-30">THE CURRENT SERVICE MODEL WAS BUILT FOR MANUFACTURERS NOT GYMS</h3>
        <p>Traditional structures support warranty processing, not gym priorities. This leaves gyms navigating gaps with little clarity. You should not be left guessing who is coming, when they will arrive, or what is being done.</p>
        <h3 class="ltn__blog-title mt-30">WE BUILT FRC AS A CONCIERGE LEVEL SOLUTION</h3>
        <p>Our service model ensures you always know who is responsible for your equipment and what the plan is. You receive planned and predictable maintenance plus a technician who feels like part of your team.</p>
        <div class="ltn__blockquote-color">
            <blockquote>
        ...
        <h3 class="ltn__blog-title mt-30">THE FUTURE IS COMPLETE TRANSPARENCY</h3>
        <p>Real updates. Real visibility. Real accountability. This is the experience gyms should have had all along.</p>
        <h3 class="ltn__blog-title mt-30">WE ARE RAISING THE STANDARD</h3>
        <p>You deserve reliability, clarity, and a partner who values your success. That is why we built Fitness Room Concierge and why we are committed to raising expectations in this industry.</p>
      `,
      comments: [],
    },
    {
      ...
      fullContent: `
        ...
        <p>Before we ever created Fitness Room Concierge, I spent years watching the same pattern appear in gyms everywhere. A treadmill breaks. Staff scramble. Nobody knows who to call. A warranty issue disappears into long delays. Members notice. Staff grow frustrated.</p>
        ...
        <h3 class="ltn__blog-title mt-30">THE CUSTOMER SHOULD ALWAYS COME FIRST</h3>
        <p>Most service systems were designed for manufacturers not gyms. That means little focus on communication, predictable timelines, dedicated technician presence, or personal accountability. We flipped that completely.</p>
        <p>A gym should never feel like they are chasing someone for updates. You should feel supported. You should feel informed. You should feel confident that your equipment will be ready.</p>
        <h3 class="ltn__blog-title mt-30">PREDICTABILITY SHOULD BE THE STANDARD</h3>
        <p>Gyms tell us the same thing. Service is unpredictable. You never know who is coming or when. That uncertainty stresses your team and frustrates members.</p>
        <p>We solve that in two ways: Planned predictable maintenance. Immediate communication when something breaks. No guessing and no chasing.</p>
        <h3 class="ltn__blog-title mt-30">A DEDICATED TECHNICIAN CREATES A BETTER EXPERIENCE</h3>
        <p>Technician inconsistency destroys trust. Every new face is a new guess. Your FRC technician becomes a familiar presence who understands your equipment mix, member patterns, and expectations. It feels closer to an in-house role than an outside vendor.</p>
        <h3 class="ltn__blog-title mt-30">COMMUNICATION SHOULD NEVER BE AN AFTERTHOUGHT</h3>
        <p>Slow updates and unclear timelines are among the biggest frustrations gyms experience. Communication is a core part of our service not an add on. You always know what is happening and what the plan is.</p>
        <div class="ltn__blockquote-color">
            <blockquote>
        ...
        <h3 class="ltn__blog-title mt-30">WE ARE HERE TO RAISE EXPECTATIONS</h3>
        <p>Reliability sets great gyms apart. When equipment works members stay confident and engaged. Your gym deserves a partner who takes that responsibility seriously. That is exactly why we built Fitness Room Concierge.</p>
      `,
      comments: [],
    },
    {
      ...
      fullContent: `
        ...
        <p>Gyms have improved equipment layouts, programming, and experience. But the service model supporting equipment reliability has barely changed.</p>
        <h3 class="ltn__blog-title mt-30">GYMS NEED REAL VISIBILITY</h3>
        <p>Most facilities cannot answer simple service questions with confidence: Who is handling this request? When will the technician arrive? What was done last time? Why is the issue recurring?</p>
        <p>Without answers, stress increases and member experience suffers. FRC removes guesswork. You always know what is happening so your team can stay focused on members.</p>
        <h3 class="ltn__blog-title mt-30">DATA CREATES PREDICTABLE OUTCOMES</h3>
        <p>Gyms often feel reactive because they do not have accurate information. Without clear service records or predictable scheduling, issues feel random. Predictability protects uptime. Predictability protects member trust.</p>
        <h3 class="ltn__blog-title mt-30">A CONSISTENT TECHNICIAN CHANGES EVERYTHING</h3>
        <p>When a new technician shows up each visit there is no continuity and no accountability. A dedicated technician improves outcomes and reduces repeat issues.</p>
        <h3 class="ltn__blog-title mt-30">PARTNERSHIP MEANS SHARED GOALS</h3>
        <p>Traditional service is transactional. A call. A visit. A wait for the next issue. A partnership is aligned. Reliable uptime, clear communication, and positive member experiences are shared priorities.</p>
        <div class="ltn__blockquote-color">
            <blockquote>
        ...
        <h3 class="ltn__blog-title mt-30">WE ARE BUILDING THE FUTURE OF GYM SERVICE</h3>
        <p>Clear information. Real transparency. Consistent results. A partner you can count on. That is the FRC standard and the future we are committed to building.</p>
      `,
      comments: [],
    },
    ...
    // --- CFO ARTICLES (IDs 4-6) ---
    {
      ...
      author: {
        name: "Olivia M.",
        image: authorOlivia,
        designation: "CFO, Fitness Room Concierge",
      },
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">EVERY MACHINE DOWN CREATES REAL COSTS</h3>
        ...
        <h3 class="ltn__blog-title mt-30">MOST GYMS OPERATE IN A CYCLE OF FINANCIAL PRESSURE</h3>
        <ul>
        ...
        <h3 class="ltn__blog-title mt-30">RUSHED SERVICE LEADS TO REPEATED SERVICE</h3>
        ...
        <h3 class="ltn__blog-title mt-30">COMMUNICATION ISSUES ADD HIDDEN ADMINISTRATIVE COSTS</h3>
    ...
    },
    {
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">INCONSISTENT SERVICE CREATES INCONSISTENT OUTCOMES</h3>
        ...
        <h3 class="ltn__blog-title mt-30">PREDICTABLE MAINTENANCE REDUCES AVOIDABLE SPENDING</h3>
        ...
        <h3 class="ltn__blog-title mt-30">A CONSISTENT TECHNICIAN REDUCES VARIABILITY</h3>
        <p>Familiarity creates accuracy. Accuracy reduces repeat visits.</p>
        
        <h3 class="ltn__blog-title mt-30">STANDARDIZATION REDUCES STAFF WORKLOAD</h3>
        ...
        <h3 class="ltn__blog-title mt-30">ACCURATE DATA SUPPORTS BETTER PLANNING</h3>
    ...
    },
    {
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">UNPREDICTABLE SERVICE CREATES UNPREDICTABLE BUDGETS</h3>
        ...
        <h3 class="ltn__blog-title mt-30">PLANNED MAINTENANCE CREATES STABILITY</h3>
        <p>Predictable care extends equipment life, reduces repairs, and minimizes downtime. Predictability protects margins.</p>
        
        <h3 class="ltn__blog-title mt-30">CONSISTENCY REDUCES FINANCIAL RISK</h3>
        ...
        <h3 class="ltn__blog-title mt-30">CLARITY SUPPORTS BETTER DECISIONS</h3>
        ...
        <h3 class="ltn__blog-title mt-30">MEMBER EXPERIENCE HAS DIRECT FINANCIAL IMPACT</h3>
        ...
        <h3 class="ltn__blog-title mt-30">GROWTH REQUIRES CONFIDENCE</h3>
    ...
    // --- DELIVERY & INSTALLATION MANAGER ARTICLES (IDs 7-8) ---
    {
      ...
      author: {
        name: "Daniel M.",
        image: authorDaniel,
        designation: "Delivery and Installation Manager, Fitness Room Concierge",
      },
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">THE FIRST EXPERIENCE CREATES LASTING EXPECTATIONS</h3>
        ...
        <h3 class="ltn__blog-title mt-30">INSTALLATION MUST BE ACCURATE, CLEAN, AND WELL COORDINATED</h3>
        ...
        <h3 class="ltn__blog-title mt-30">COMMUNICATION WITH THE GYM IS JUST AS IMPORTANT AS THE INSTALLATION ITSELF</h3>
        ...
        <h3 class="ltn__blog-title mt-30">DELIVERY AND INSTALLATION IMPACT FUTURE SERVICE QUALITY</h3>
        ...
        <h3 class="ltn__blog-title mt-30">THE EXPERIENCE SHOULD FEEL ORGANIZED FROM START TO FINISH</h3>
    ...
    },
    {
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">GYMS NEED CLEAR COMMUNICATION BEFORE THE INSTALLATION BEGINS</h3>
        ...
        <h3 class="ltn__blog-title mt-30">PREPARATION IS WHAT PREVENTS OPERATIONAL DISRUPTION</h3>
        ...
        <h3 class="ltn__blog-title mt-30">THE FLOOR SHOULD NEVER FEEL CHAOTIC</h3>
        ...
        <h3 class="ltn__blog-title mt-30">ACCURACY IS MORE IMPORTANT THAN SPEED</h3>
        ...
        <h3 class="ltn__blog-title mt-30">THE FINAL WALKTHROUGH BUILDS CONFIDENCE</h3>
    ...
    // --- COO ARTICLES (IDs 9-11) ---
    {
      ...
      author: {
        name: "Brad H.",
        image: authorBrad,
        designation: "COO, Fitness Room Concierge",
      },
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">GYMS CANNOT OPERATE ON GUESSWORK</h3>
        ...
        <h3 class="ltn__blog-title mt-30">THE MOBILE AND WEB APP GIVE YOU REAL VISIBILITY</h3>
        ...
        <h3 class="ltn__blog-title mt-30">MEETING SLAS REQUIRES A SYSTEM BUILT FOR ACCOUNTABILITY</h3>
        ...
        <h3 class="ltn__blog-title mt-30">PREDICTABLE MAINTENANCE PROTECTS YOUR UPTIME</h3>
        ...
        <h3 class="ltn__blog-title mt-30">A CONSISTENT TECHNICIAN CREATES BETTER OUTCOMES</h3>
    ...
    },
    {
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">THE FRC APP GIVES YOU TOTAL SERVICE VISIBILITY</h3>
        ...
        <h3 class="ltn__blog-title mt-30">A CONSISTENT TECHNICIAN REDUCES VARIABLES</h3>
        ...
        <h3 class="ltn__blog-title mt-30">PREDICTABLE MAINTENANCE IMPROVES UPTIME</h3>
        ...
        <h3 class="ltn__blog-title mt-30">MEETING SLAS REQUIRES REAL SYSTEMS NOT PROMISES</h3>
    ...
    },
    {
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">THE INDUSTRY WAS NOT DESIGNED FOR GYM PRIORITIES</h3>
        ...
        <h3 class="ltn__blog-title mt-30">WARRANTY FACILITATION IS A MAJOR PAIN POINT</h3>
        ...
        <h3 class="ltn__blog-title mt-30">OEM VIEWS OF SERVICE PROVIDERS CREATE LIMITATIONS</h3>
        ...
        <h3 class="ltn__blog-title mt-30">TECHNICIAN TURNOVER IS A SYMPTOM NOT THE CAUSE</h3>
        ...
        <h3 class="ltn__blog-title mt-30">THE COMMUNICATION GAP IS BUILT INTO THE OLD MODEL</h3>
        ...
        <h3 class="ltn__blog-title mt-30">FRC WAS BUILT TO FIX THE STRUCTURAL PROBLEMS</h3>
    ...
    // --- REGIONAL SERVICE MANAGER ARTICLES (IDs 12-14) ---
    {
      ...
      author: {
        name: "Zach M.",
        image: authorZach,
        designation: "Regional Service Manager, Fitness Room Concierge",
      },
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">CONSISTENCY BUILDS TECHNICIAN FAMILIARITY WITH YOUR GYM</h3>
        ...
        <h3 class="ltn__blog-title mt-30">CONSISTENCY REDUCES REPEAT ISSUES</h3>
        ...
        <h3 class="ltn__blog-title mt-30">CONSISTENCY IMPROVES COMMUNICATION WITH STAFF</h3>
        ...
        <h3 class="ltn__blog-title mt-30">CONSISTENCY CREATES STRONGER MEMBER CONFIDENCE</h3>
        ...
        <h3 class="ltn__blog-title mt-30">CONSISTENCY SUPPORTS PLANNED MAINTENANCE AND PREDICTABLE UPTIME</h3>
        ...
        <h3 class="ltn__blog-title mt-30">SPEED MATTERS, BUT CONSISTENCY CREATES QUALITY</h3>
    ...
    },
    {
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">WE LOOK FOR TECHNICIANS WHO TAKE OWNERSHIP</h3>
        ...
        <h3 class="ltn__blog-title mt-30">WE VALUE CHARACTER AS MUCH AS TECHNICAL ABILITY</h3>
        ...
        <h3 class="ltn__blog-title mt-30">OUR ONBOARDING PROCESS BUILDS CONSISTENCY FROM DAY ONE</h3>
        ...
        <h3 class="ltn__blog-title mt-30">THE TECHNICIAN IS TRAINED TO USE OUR APP AS A TOOL, NOT AN OBLIGATION</h3>
        ...
        <h3 class="ltn__blog-title mt-30">WE SET EXPECTATIONS FOR CONSISTENCY AND ROUTINE</h3>
    ...
    },
    {
      ...
      fullContent: `
        ...
        <h3 class="ltn__blog-title mt-30">OEM COMMUNICATION DELAYS CAN STOP SERVICE BEFORE IT EVEN STARTS</h3>
        ...
        <h3 class="ltn__blog-title mt-30">SERVICE REQUESTS OFTEN GET MISROUTED BEFORE THEY REACH A TECHNICIAN</h3>
        ...
        <h3 class="ltn__blog-title mt-30">PARTS DELAYS ARE A REALITY, BUT HOW THEY ARE MANAGED MAKES THE DIFFERENCE</h3>
        ...
        <h3 class="ltn__blog-title mt-30">INCONSISTENT DOCUMENTATION CREATES REPEAT ISSUES</h3>
        ...
        <h3 class="ltn__blog-title mt-30">TECHNICIAN TURNOVER FROM OTHER PROVIDERS CREATES UNSEEN INSTABILITY</h3>
        ...
        <h3 class="ltn__blog-title mt-30">FRC SOLVES THESE PROBLEMS BEFORE THEY HIT YOUR FLOOR</h3>
